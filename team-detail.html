...
<!-- Mirrored from kodeforest.net/html/eco-friendly/team-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Nov 2022 16:16:31 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Title of this page -->
    <title>Eco team detail by kodeforest</title>
	...
	<div class="eco_wrapper"> 
		...
		<div class="eco_banner eco_inner_page_banner">
			...
			<div class="eco_headings">
				<h3><b>team</b> detail</h3>
			</div>
			<ul class="eco_page_link">
				<li><a href="#">team</a></li>
				<li class="active"><a href="#">team detail</a></li>
			</ul>
		</div>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-md-9 col-sm-12 responsive-991-width">
								...
								<div class="eco_team_detail_column">
									<div class="team-detail-items">
										<figure>
											<img src="extra-images/team_detail_img01.jpg" alt="">
										</figure>
									</div>
									<div class="just-team-for-detail">
										<div class="eco_headings">
											<h3>ryan haris</h3>
											<h5>Volenteer</h5>
										</div>
										<div class="detail-communication">
										...
										<p>nteger venenatis sollicitudin pulvinar. Pellentesque quis feugiat ex, non tempor ipsum. Donec venenatis leo vel magna hendrerit mollis. Donec volutpat felis varius, vehicula eros vel, consequat nisi. Mauris non felis at sem euismod laoreet. Nunc vitae orci sed orci molestie mollis et et ex.</p>
									</div>
									<div class="volenteer_blockquote">
									...
									<div class="eco_area_experince">
										<h5 class="eco_sm_titles">Area of Expertise</h5>
										<p>Fusce est leo, dapibus non pellentesque sed, scelerisque nec sapien. In accumsan efficitur gravida. Nam eget neque quis nisi pulvinar molestie.</p>
										<ul class="eco_expertise">
											<li><p>Growth Strategy</p></li>
											<li><p>Compaign Information</p></li>
											<li><p>Donation Planning</p></li>
											<li><p>Money Transaction Guide</p></li>
											<li><p>10 Persons in network</p></li>
										</ul>
									</div>
									<div class="eco_skills">
										<h5 class="eco_sm_titles">My Skills</h5>
										<p>Mauris luctus dapibus arcu, eget porta nisi placerat non. Donec ultrices nulla nisi, quis iaculis neque hendrerit ut. Integer tincidunt venenatis urna.</p>
										<div class="eco-progress-row">
											<span class="eco_progress-heading color-change">70%</span>
											<span class="eco_progress-heading">Funded</span>
										...
										<div class="eco-progress-row">
											<span class="eco_progress-heading color-change">70%</span>
											<span class="eco_progress-heading">growth level</span>
											<div class="progress-wrap progress" data-progress-percent="55">
												<div class="progress-bar progress " style="width:20%;"></div>
											</div>
										</div>
										...
										<div class="eco-progress-row">
											<span class="eco_progress-heading color-change">70%</span>
											<span class="eco_progress-heading">management power</span>
											<div class="progress-wrap progress" data-progress-percent="55">
												<div class="progress-bar progress " style="width:20%;"></div>
											</div>
										</div>
							...
							<div class="col-md-3 col-sm-12 responsive-991-width">
								...
								<!--Eco Right Side search menu ends-->
								...
								<!--Eco Right Side Best donors posts-->
								<div class="margin-buttom_50 responsive-column responsive-devider-50">	
									...
									<!--Eco Right Side donors-->
								</div>
								<!--Eco Right Side Best donors posts ends-->
								...
								<div class="margin-buttom_30 responsive-column responsive-devider-50">	
									<div class="widget_post_content">
										...
										<!--Eco featured widget column posts ends-->
									</div>
								</div>
								<!--Eco Right Side Tags ends-->
...
<!-- Mirrored from kodeforest.net/html/eco-friendly/team-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Nov 2022 16:16:33 GMT -->
</html>